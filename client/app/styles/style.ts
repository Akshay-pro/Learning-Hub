export const styles = {
    ...
    button: "flex flex-row justify-center items-center py-3 px-4 rounded-full cursor-pointer bg-[#2190ff] min-h-[45px] w-full text-[15px] font-Poppins font-semibold"
}